...
File:           Google Map Config
Version:        1.0
Last change:    31/08/16
Author:         Suelo
...
function initMapSingle() {
    ...
    var yourLatitude = 50.064650; $googleMap.data('your-latitude');
    var yourLongitude = 19.944980; $googleMap.data('your-longitude');

    var yourStyle = $googleMap.data('style');     
